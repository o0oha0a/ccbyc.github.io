...
function showWelcome() {
  ...
  let dist = getDistance(101.97222, 38.24711, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
  ...
  try {
    ...
    document.getElementById("welcome-info").innerHTML =
      `<b><center>🎉 欢迎信息 🎉</center>&emsp;&emsp;欢迎来自 <span style="color:var(--theme-color)">${pos}</span> 的小伙伴，${timeChange}您现在距离建行永昌支行约 <span style="color:var(--theme-color)">${dist}</span> 公里，当前的IP地址为： <span style="color:var(--theme-color)">${ip}</span>， ${posdesc}</b>`;
  } catch (err) {
...
function createtime1() {
  var grt = new Date("08/10/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by owner💗 %c 你正在访问owner💗de小家",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("08/10/2023 00:00:00");
...
<p id="swfs">
<a class="swf" id="swf_ZhuZiAWan" href="javascript:;" rel="noopener external nofollow" style="color: rgb(48, 48, 48); font-family: ZhuZiAWan !important; border: 2px solid var(--border-color);" onclick="setFont('ZhuZiAWan')">筑紫A丸标准体2.0</a>
...
<a class="swf" id="swf_LXGW" href="javascript:;" rel="noopener external nofollow" style="color: rgb(48, 48, 48); font-family: LXGW !important; border: 2px solid var(--theme-color);" onclick="setFont('LXGW')">霞鹜文楷</a>
