...
function tonav() {
    ...
    $(window).scroll((function() {
        ...
        t > e ? (document.getElementById("name-container").setAttribute("style", ""),
        document.getElementsByClassName("menus_items")[1].setAttribute("style", "display:none!important")) : (document.getElementsByClassName("menus_items")[1].setAttribute("style", ""),
        document.getElementById("name-container").setAttribute("style", "display:none")),
        e = t
    }
    )),
...
function showWelcome() {
    let e, t, n, o = getDistance(113.34499552, 23.15537143, ipLoacation.result.location.lng, ipLoacation.result.location.lat), a = ipLoacation.result.ad_info.nation;
    ...
    case "加拿大":
        ...
        break;
    case "中国":
        switch (a = ipLoacation.result.ad_info.province + " " + ipLoacation.result.ad_info.city + " " + ipLoacation.result.ad_info.district,
    ...
    let s = new Date;
    n = s.getHours() >= 5 && s.getHours() < 11 ? "<span>上午好</span>，一日之计在于晨！" : s.getHours() >= 11 && s.getHours() < 13 ? "<span>中午好</span>，该摸鱼吃午饭了。" : s.getHours() >= 13 && s.getHours() < 15 ? "<span>下午好</span>，懒懒地睡个午觉吧！" : s.getHours() >= 15 && s.getHours() < 16 ? "<span>三点几啦</span>，一起饮茶呀！" : s.getHours() >= 16 && s.getHours() < 19 ? "<span>夕阳无限好！</span>" : s.getHours() >= 19 && s.getHours() < 24 ? "<span>晚上好</span>，夜生活嗨起来！" : "夜深了，早点休息，少熬夜。";
    try {
        document.getElementById("welcome-info").innerHTML = `<b><center>🎉 欢迎信息 🎉</center>&emsp;&emsp;欢迎来自 <span style="color:var(--blue-custom)">${a}</span> 的小伙伴，${n}您现在距离站长约 <span style="color:var(--blue-custom)">${o}</span> 公里，当前的IP地址为： <span style="color:var(--blue-custom)">${e}</span>， ${t}</b>`
    } catch (e) {}
}
...
function dark() {
    ...
    var e, t, n, o, a = .05, s = document.getElementById("universe"), i = !0, c = "226,225,224", l = [];
    function r() {
        e = window.innerWidth,
    ...
    function u() {
        ...
        this.fadeOut = function() {
            ...
            (this.x > e || this.y < 0) && (this.fadingOut = !1,
            this.reset()))
        }
        ,
        this.draw = function() {
            ...
            this.giant)
                ...
                o.fillStyle = "rgba(" + c + "," + this.opacity + ")",
                o.arc(this.x, this.y, 1.5, 0, 2 * Math.PI, !1);
                for (var e = 0; e < 30; e++)
                    o.fillStyle = "rgba(" + c + "," + (this.opacity - this.opacity / 20 * e) + ")",
                    o.rect(this.x - this.dx / 4 * e, this.y - this.dy / 4 * e - 2, 2, 2),
                    o.fill()
            } else
...
function owoBig() {
    ...
    let a = new MutationObserver((a=>{
        for (let s = 0; s < a.length; s++) {
            let i = a[s].addedNodes
              , c = "";
            2 == i.length && "OwO-body" == i[1].className && (c = i[1],
            document.body.clientWidth <= 768 && c.addEventListener("contextmenu", (e=>e.preventDefault())),
            c.onmouseover = a=>{
                e && "IMG" == a.target.tagName && (e = 0,
                t = setTimeout((()=>{
                    ...
                    s < 0 && (s = 10),
                    n.style.cssText = `display:flex; height:${e}px; width:${t}px; left:${s}px; top:${i}px;`,
...
navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i) || window && (()=>{
    let e = 50
      ...
      , s = .7
      , i = .5;
    const c = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
        window.setTimeout(e, 1e3 / 60)
    }
    ;
    window.requestAnimationFrame = c;
    const l = document.getElementById("snow")
      , r = l.getContext("2d")
      , d = e;
    let u = -100
      , b = -100
    ...
    const g = ()=>{
        ...
        for (let t = 0; t < d; t++) {
            ...
            r.fillStyle = "rgba(" + n + ", " + o.opacity + ")",
            o.y += o.velY,
            o.x += o.velX,
            (o.y >= l.height || o.y <= 0) && f(o),
            (o.x >= l.width || o.x <= 0) && f(o),
            r.beginPath(),
            r.arc(o.x, o.y, o.size, 0, 2 * Math.PI),
            r.fill()
        }
        c(g)
    }
      , f = e=>{
        e.x = Math.floor(Math.random() * l.width),
        e.y = 0,
    ...
    (()=>{
        for (let e = 0; e < d; e++) {
            const e = Math.floor(Math.random() * l.width)
              , t = Math.floor(Math.random() * l.height)
              , n = 3 * Math.random() + o
              , c = 1 * Math.random() + a
              , r = .5 * Math.random() + s;
            m.push({
    ...
    !function(e) {
        e.fn.nekoScroll = function(t) {
            var n = e.extend({
              ...
              , o = "" !== this.prop("className") ? "." + this.prop("className") : "" !== this.prop("id") ? "#" + this.prop("id") : this.prop("nodeName");
            0 == e(".neko").length && this.after('<div class="neko" id=' + n.nekoname + ' data-msg="' + n.hoverMsg + '"></div>');
            let a = getBasicInfo();
            return e(o).css({
                position: "fixed",
                width: n.scroWidth,
                top: n.top,
                height: a.Band_H * n.zoom * a.ViewH * .01 + "px",
                "z-index": n.z_index,
            ...
            e("#" + n.nekoname).css({
                position: "fixed",
                top: a.Band_H * n.zoom * a.ViewH * .01 - 50 + "px",
            ...
            e(window).scroll((function() {
                ...
                e(o).css({
                    ...
                    width: n.scroWidth,
                    top: n.top,
                    height: t.Band_H * n.zoom * t.ViewH * .01 + "px",
                    "z-index": n.z_index,
                    "background-color": n.bgcolor,
                    "border-radius": n.borderRadius,
                    right: n.right,
                ...
                e("#" + n.nekoname).css({
                    position: "fixed",
                    top: t.Band_H * n.zoom * t.ViewH * .01 - 50 + "px",
                    "z-index": 10 * n.z_index,
                    right: n.right,
                    "background-image": "url(" + n.nekoImg + ")"
                }),
                t.ScrollTop == t.S_V ? e("#" + n.nekoname).addClass("showMsg") : (e("#" + n.nekoname).removeClass("showMsg"),
...
function popupMenu() {
    window.oncontextmenu = function(e) {
        ...
        t = e.target;
        /^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&'\*\+,;=.]+$/.test(window.getSelection().toString()) && "A" != t.tagName && $("#menu-too").show(),
        "A" == t.tagName ? ($("#menu-to").show(),
        rmf.open = function() {
            -1 == t.href.indexOf("http://") && -1 == t.href.indexOf("https://") || -1 != t.href.indexOf("yisous.xyz") ? pjax.loadUrl(t.href) : location.href = t.href
        }
        ,
        ...
        let n = e.clientX + 10
          ...
          , a = $("#rightMenu").width()
          , s = $("#rightMenu").height();
        return n + a > window.innerWidth && (n -= a + 10),
...
function changeMouseMode() {
    "on" == localStorage.getItem("mouse") ? (mouseMode = "off",
...
function createtime1() {
    ...
    var t = (now1 - e) / 1e3 / 60 / 60 / 24
      , n = ["欢迎来到Fomalhaut🥝の小家!", "Future is now 🍭🍭🍭", "\n        \n███████  ██████  ███    ███  █████  ██      ██   ██  █████  ██    ██ ████████ \n██      ██    ██ ████  ████ ██   ██ ██      ██   ██ ██   ██ ██    ██    ██    \n█████   ██    ██ ██ ████ ██ ███████ ██      ███████ ███████ ██    ██    ██    \n██      ██    ██ ██  ██  ██ ██   ██ ██      ██   ██ ██   ██ ██    ██    ██    \n██       ██████  ██      ██ ██   ██ ███████ ██   ██ ██   ██  ██████     ██   \n                                              \n", "小站已经苟活", Math.floor(t), "天啦!", "©2022 By Fomalhaut"];
    setTimeout(console.log.bind(console, `\n%c ${n[0]} %c ${n[1]} %c ${n[2]} %c ${n[3]}%c ${n[4]}%c ${n[5]}\n\n%c ${n[6]}\n`, "color:#39c5bb", "", "color:#39c5bb", "color:#39c5bb", "", "color:#39c5bb", ""))
}
function createtime2() {
    var e = ["NCC2-036", "调用前置摄像头拍照成功，识别为「大聪明」", "Photo captured: ", " 🤪 "];
    setTimeout(console.log.bind(console, `%c ${e[0]} %c ${e[1]} %c \n ${e[2]} %c\n ${e[3]}`, "color:white; background-color:#10bcc0", "", "", 'background:url("https://unpkg.zhimg.com/anzhiyu-assets@latest/image/common/tinggge.gif") no-repeat;font-size:450%')),
    setTimeout(console.log.bind(console, "%c WELCOME %c 欢迎光临，大聪明", "color:white; background-color:#23c682", "")),
    setTimeout(console.warn.bind(console, "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问Fomalhaut🥝の小家", "color:white; background-color:#f0ad4e", "")),
...
document.addEventListener("visibilitychange", (function() {
    ...
    clearTimeout(titleTime)) : (document.title = "🐖抓到你啦～",
...
function solarDays(e, t) {
    if (t > 12 || t < 1)
        return -1;
    var n = t - 1;
    return 1 === n ? e % 4 == 0 && e % 100 != 0 || e % 400 == 0 ? 29 : 28 : solarMonth[n]
}
...
function getTerm(e, t) {
    ...
    var n = sTermInfo[e - 1900]
      , o = [parseInt("0x" + n.substr(0, 5)).toString(), parseInt("0x" + n.substr(5, 5)).toString(), parseInt("0x" + n.substr(10, 5)).toString(), parseInt("0x" + n.substr(15, 5)).toString(), parseInt("0x" + n.substr(20, 5)).toString(), parseInt("0x" + n.substr(25, 5)).toString()]
      , a = [o[0].substr(0, 1), o[0].substr(1, 2), o[0].substr(3, 1), o[0].substr(4, 2), o[1].substr(0, 1), o[1].substr(1, 2), o[1].substr(3, 1), o[1].substr(4, 2), o[2].substr(0, 1), o[2].substr(1, 2), o[2].substr(3, 1), o[2].substr(4, 2), o[3].substr(0, 1), o[3].substr(1, 2), o[3].substr(3, 1), o[3].substr(4, 2), o[4].substr(0, 1), o[4].substr(1, 2), o[4].substr(3, 1), o[4].substr(4, 2), o[5].substr(0, 1), o[5].substr(1, 2), o[5].substr(3, 1), o[5].substr(4, 2)];
...
function solar2lunar(e, t, n) {
    ...
    t = s.getMonth() + 1,
    n = s.getDate();
    var c = (Date.UTC(s.getFullYear(), s.getMonth(), s.getDate()) - Date.UTC(1900, 0, 31)) / 864e5;
    for (o = 1900; o < 2101 && c > 0; o++)
        c -= i = lYearDays(o);
    c < 0 && (c += i,
    o--);
    var l = new Date
      , r = !1;
    l.getFullYear() === e && l.getMonth() + 1 === t && l.getDate() === n && (r = !0);
    var d = s.getDay()
      , u = nStr1[d];
    0 === d && (d = 7);
    var b = o;
    ...
    for (o = 1; o < 13 && c > 0; o++)
        a > 0 && o === a + 1 && !1 === m ? (--o,
        m = !0,
        i = leapDays(b)) : i = monthDays(b, o),
        !0 === m && o === a + 1 && (m = !1),
        c -= i;
    0 === c && a > 0 && o === a + 1 && (m ? m = !1 : (m = !0,
    --o)),
    c < 0 && (c += i,
    --o);
    var g = o
...
var calendarFormatter = {
    ...
    lunar2solar: function(e, t, n, o) {
        if ((o = !!o) && leapMonth !== t)
            return -1;
        if (2100 === e && 12 === t && n > 1 || 1900 === e && 1 === t && n < 31)
            return -1;
        var a = monthDays(e, t)
          , s = a;
        if (o && (s = leapDays(e, t)),
        e < 1900 || e > 2100 || n > s)
            return -1;
        for (var i = 0, c = 1900; c < e; c++)
            i += lYearDays(c);
        var l = 0
          , r = !1;
        for (c = 1; c < t; c++)
            l = leapMonth(e),
            r || l <= c && l > 0 && (i += leapDays(e),
            r = !0),
            i += monthDays(e, c);
        o && (i += a);
        var d = Date.UTC(1900, 1, 30, 0, 0, 0)
          , u = new Date(864e5 * (i + n - 31) + d);
        return solar2lunar(u.getUTCFullYear(), u.getUTCMonth() + 1, u.getUTCDate())
    }
}
  , d = new Date;
m = d.getMonth() + 1,
dd = d.getDate(),
y = d.getFullYear(),
9 == m && 18 == dd && (document.getElementsByTagName("html")[0].setAttribute("style", "filter: grayscale(60%);"),
"1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("今天是九一八事变" + (y - 1931).toString() + "周年纪念日\n🪔勿忘国耻，振兴中华🪔"),
sessionStorage.setItem("isPopupWindow", "1"))),
7 == m && 7 == dd && (document.getElementsByTagName("html")[0].setAttribute("style", "filter: grayscale(60%);"),
"1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("今天是卢沟桥事变" + (y - 1937).toString() + "周年纪念日\n🪔勿忘国耻，振兴中华🪔"),
sessionStorage.setItem("isPopupWindow", "1"))),
12 == m && 13 == dd && (document.getElementsByTagName("html")[0].setAttribute("style", "filter: grayscale(60%);"),
"1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("今天是南京大屠杀" + (y - 1937).toString() + "周年纪念日\n🪔勿忘国耻，振兴中华🪔"),
sessionStorage.setItem("isPopupWindow", "1"))),
8 == m && 14 == dd && (document.getElementsByTagName("html")[0].setAttribute("style", "filter: grayscale(60%);"),
"1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("今天是世界慰安妇纪念日\n🪔勿忘国耻，振兴中华🪔"),
sessionStorage.setItem("isPopupWindow", "1"))),
10 == m && dd <= 3 && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("祝祖国" + (y - 1949).toString() + "岁生日快乐！"),
sessionStorage.setItem("isPopupWindow", "1")),
8 == m && 15 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("小日子已经投降" + (y - 1945).toString() + "年了😃"),
sessionStorage.setItem("isPopupWindow", "1")),
1 == m && 1 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire(y.toString() + "年元旦快乐！🎉"),
sessionStorage.setItem("isPopupWindow", "1")),
3 == m && 8 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("各位女神们，妇女节快乐！👩"),
sessionStorage.setItem("isPopupWindow", "1")),
l = ["非常抱歉，因为不可控原因，博客将于明天停止运营！", "好消息，日本没了！", "美国垮了，原因竟然是川普！", "微软垮了！", "你的电脑已经过载，建议立即关机！", "你知道吗？站长很喜欢你哦！", "一分钟有61秒哦", "你喜欢的人跟别人跑了！"],
4 == m && 1 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire(l[Math.floor(Math.random() * l.length)]),
sessionStorage.setItem("isPopupWindow", "1")),
5 == m && 1 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("劳动节快乐\n为各行各业辛勤工作的人们致敬！"),
sessionStorage.setItem("isPopupWindow", "1")),
5 == m && 4 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("青年节快乐\n青春不是回忆逝去,而是把握现在！"),
sessionStorage.setItem("isPopupWindow", "1")),
5 == m && 20 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("今年是520情人节\n快和你喜欢的人一起过吧！💑"),
sessionStorage.setItem("isPopupWindow", "1")),
7 == m && 1 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("祝中国共产党" + (y - 1921).toString() + "岁生日快乐！"),
sessionStorage.setItem("isPopupWindow", "1")),
9 == m && 10 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("各位老师们教师节快乐！👩‍🏫"),
sessionStorage.setItem("isPopupWindow", "1")),
12 == m && 25 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("圣诞节快乐！🎄"),
sessionStorage.setItem("isPopupWindow", "1")),
8 == m && 11 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("祝站长" + (y - 1998).toString() + "岁生日快乐！🥝"),
sessionStorage.setItem("isPopupWindow", "1")),
6 == m && 30 == dd && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("祝小猫咪" + (y - 1999).toString() + "岁生日快乐！🐱"),
sessionStorage.setItem("isPopupWindow", "1")),
(2023 == y && 4 == m && 5 == dd || 2024 == y && 4 == m && 4 == dd || 2025 == y && 4 == m && 4 == dd) && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("清明时节雨纷纷,一束鲜花祭故人💐"),
sessionStorage.setItem("isPopupWindow", "1")),
(2023 == y && 12 == m && 22 == dd || 2024 == y && 12 == m && 21 == dd || 2025 == y && 12 == m && 21 == dd) && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("冬至快乐\n快吃上一碗热热的汤圆和饺子吧🧆"),
sessionStorage.setItem("isPopupWindow", "1"));
var CURSOR, lunar = calendarFormatter.solar2lunar();
("正月" == lunar.IMonthCn && "初六" == lunar.IDayCn || "正月" == lunar.IMonthCn && "初五" == lunar.IDayCn || "正月" == lunar.IMonthCn && "初四" == lunar.IDayCn || "正月" == lunar.IMonthCn && "初三" == lunar.IDayCn || "正月" == lunar.IMonthCn && "初二" == lunar.IDayCn || "正月" == lunar.IMonthCn && "初一" == lunar.IDayCn || "腊月" == lunar.IMonthCn && "三十" == lunar.IDayCn || "腊月" == lunar.IMonthCn && "廿九" == lunar.IDayCn) && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire(y.toString() + "年新年快乐\n🎊祝你心想事成，诸事顺利🎊"),
sessionStorage.setItem("isPopupWindow", "1")),
"正月" == lunar.IMonthCn && "十五" == lunar.IDayCn && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("元宵节快乐\n送你一个大大的灯笼🧅"),
sessionStorage.setItem("isPopupWindow", "1")),
"五月" == lunar.IMonthCn && "初五" == lunar.IDayCn && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("端午节快乐\n请你吃一条粽子🍙"),
sessionStorage.setItem("isPopupWindow", "1")),
"七月" == lunar.IMonthCn && "初七" == lunar.IDayCn && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("七夕节快乐\n黄昏后,柳梢头,牛郎织女来碰头"),
sessionStorage.setItem("isPopupWindow", "1")),
"八月" == lunar.IMonthCn && "十五" == lunar.IDayCn && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("中秋节快乐\n请你吃一块月饼🍪"),
sessionStorage.setItem("isPopupWindow", "1")),
"九月" == lunar.IMonthCn && "初九" == lunar.IDayCn && "1" != sessionStorage.getItem("isPopupWindow") && (Swal.fire("重阳节快乐\n独在异乡为异客，每逢佳节倍思亲"),
sessionStorage.setItem("isPopupWindow", "1")),
...
class Cursor {
    ...
    create() {
        ...
        this.scr.innerHTML = "* {cursor: url(\"data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8' width='8px' height='8px'><circle cx='4' cy='4' r='4' opacity='1.0' fill='" + t + "'/></svg>\") 4 4, auto}"
    }
    refresh() {
        this.scr.remove(),
...
function createtime() {
    ...
    var e = new Date("08/01/2022 00:00:00")
      ...
      , s = Math.floor(a)
      , i = (now - o) / 1e3 / 60 / 60 - 24 * s
      , c = Math.floor(i);
    1 == String(c).length && (c = "0" + c);
    var l = (now - o) / 1e3 / 60 - 1440 * s - 60 * c
      , r = Math.floor(l);
    1 == String(r).length && (r = "0" + r);
    var d = (now - o) / 1e3 - 86400 * s - 3600 * c - 60 * r
      , u = Math.round(d);
    1 == String(u).length && (u = "0" + u);
    let b = "";
    b = c < 18 && c >= 9 ? `<img class='boardsign' src='https://sourcebucket.s3.bitiful.net/badge/F小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${s} 天 ${c} 小时 ${r} 分 ${u} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${t} 千米，约为 ${n} 个天文单位 🚀</div>` : `<img class='boardsign' src='https://sourcebucket.s3.bitiful.net/badge/F小屋-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${s} 天 ${c} 小时 ${r} 分 ${u} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${t} 千米，约为 ${n} 个天文单位 🚀</div>`,
    document.getElementById("workboard") && (document.getElementById("workboard").innerHTML = b)
}
function startFps() {
    var e = window.requestAnimationFrame || window.webkitRequestAnimationFrame || function(e) {
        window.setTimeout(e, 1e3 / 60)
    }
      , t = 0
      , n = Date.now()
      ...
      , a = function() {
        ...
        t++,
        s > 1e3 + n) {
            if ((c = Math.round(1e3 * t / (s - n))) <= 5)
                var l = '<span style="color:#bd0000">卡成ppt🤢</span>';
            else if (c <= 15)
                l = '<span style="color:red">电竞级帧率😖</span>';
            else if (c <= 25)
                l = '<span style="color:orange">有点难受😨</span>';
            else if (c < 35)
                l = '<span style="color:#9338e6">不太流畅🙄</span>';
            else if (c <= 45)
                l = '<span style="color:#08b7e4">还不错哦😁</span>';
            else
                l = '<span style="color:#39c5bb">十分流畅😂</span>';
            document.getElementById("fps").innerHTML = `FPS:${c} ${l}`,
            t = 0,
            n = s
        }
        e(a)
...
null == localStorage.getItem("reset_8")) {
...
function setFont(e) {
    ...
    "default" == e ? (document.documentElement.style.setProperty("--global-font", "-apple-system"),
    document.body.style.fontFamily = "-apple-system, Consolas_1, BlinkMacSystemFont, 'Segoe UI' , 'Helvetica Neue' , Lato, Roboto, 'PingFang SC' , 'Microsoft JhengHei' , 'Microsoft YaHei' , sans-serif") : (document.documentElement.style.setProperty("--global-font", e),
...
function setFontBorder() {
    ...
    Array.prototype.forEach.call(document.getElementsByClassName("swf"), (function(t) {
        t.id != e && (t.style.border = "2px solid var(--border-color)")
    }
    ))
}
function setColor(e) {
    document.getElementById("themeColor").innerText = ":root{--theme-color:" + map.get(e) + " !important}",
...
function setUniverse() {
    document.getElementById("universeSet").checked ? (document.getElementById("universe").style.display = "block",
    localStorage.setItem("universe", "block")) : (document.getElementById("universe").style.display = "none",
    localStorage.setItem("universe", "none"))
}
function setSnow() {
    document.getElementById("snowSet").checked ? (document.getElementById("snow").style.display = "block",
    localStorage.setItem("snow", "block")) : (document.getElementById("snow").style.display = "none",
    localStorage.setItem("snow", "none"))
}
function addNavClass() {
    "1" == localStorage.getItem("nav") ? (document.getElementById("nav").classList.add("nav_fixed"),
    document.getElementById("nav").classList.remove("nav_visible"),
    document.getElementById("nav-display").innerText = ":root{--nav-visible-display:none;--nav-fixed-display:inline-flex;}") : (document.getElementById("nav").classList.add("nav_visible"),
...
function fpssw() {
    document.getElementById("fpson").checked ? (document.getElementById("fps").style.display = "block",
    localStorage.setItem("fpson", "1")) : (document.getElementById("fps").style.display = "none",
...
function toggleRightside() {
    document.getElementById("rightSideSet").checked ? (localStorage.setItem("rs", "block"),
    document.getElementById("rightSide").innerText = ":root{--rightside-display: block}") : (localStorage.setItem("rs", "none"),
...
null == localStorage.getItem("themeColor") && localStorage.setItem("themeColor", "green"),
setColor(localStorage.getItem("themeColor")),
null == localStorage.getItem("universe") && localStorage.setItem("universe", "block"),
...
startFps(),
1 == localStorage.getItem("fpson") ? document.getElementById("fps").style.display = "block" : document.getElementById("fps").style.display = "none",
null == localStorage.getItem("rs") && localStorage.setItem("rs", "block"),
"block" == localStorage.getItem("rs") ? document.getElementById("rightSide").innerText = ":root{--rightside-display: block}" : document.getElementById("rightSide").innerText = ":root{--rightside-display: none}",
null == localStorage.getItem("aside") && localStorage.setItem("aside", "1"),
"1" == localStorage.getItem("aside") ? document.getElementById("aside-show").innerText = ":root{--layout-justify-content: unset; --aside-content-display: block;}" : document.getElementById("aside-show").innerText = ":root{--layout-justify-content: center; --aside-content-display: none;}",
null == localStorage.getItem("asidePos") && localStorage.setItem("asidePos", "1"),
"1" == localStorage.getItem("asidePos") ? document.getElementById("aside-pos").innerText = ":root{--first-child-order: 0; --recent-post-item-margin: 0px 1% 20px 0px;}" : document.getElementById("aside-pos").innerText = ":root{--first-child-order: 2; --recent-post-item-margin: 0px 0px 20px 1%;}",
null == localStorage.getItem("transNum") && localStorage.setItem("transNum", 98);
var curTransNum = localStorage.getItem("transNum")
  , curTransMini = .95 * curTransNum;
function setTrans() {
    var e = document.getElementById("transSet").value;
    document.querySelector(".transValue").innerHTML = '卡片透明度 (0%-100%): <span style="color:#eb5353">' + e + "%</span>",
    localStorage.setItem("transNum", e),
    curTransMini = .95 * e,
    curTransNum = e,
    document.querySelector("#rang_trans").style.width = curTransMini + "%",
    document.getElementById("transPercent").innerText = `:root{--trans-light: rgba(250, 250, 250, ${e}%) !important; --trans-dark: rgba(28, 28, 28, ${e}%) !important} `
}
...
null == localStorage.getItem("lastTime") && localStorage.setItem("lastTime", Date.now() - 2916e4);
let deltaSeconds = (Date.now() - localStorage.getItem("lastTime")) / 1e3;
if (deltaSeconds > 28800) {
    localStorage.setItem("lastTime", Date.now());
    var curHour = (new Date).getHours()
      , curMode = document.getElementsByTagName("html")[0].getAttribute("data-theme");
    (curHour >= 19 || curHour < 7) && "dark" != curMode ? (activateDarkMode(),
    saveToLocal.set("theme", "dark", 2),
    document.getElementById("modeicon").setAttribute("xlink:href", "#icon-sun")) : curHour >= 7 && curHour < 19 && "light" != curMode && (activateLightMode(),
    saveToLocal.set("theme", "light", 2),
    document.querySelector("body").classList.add("DarkMode"),
    document.getElementById("modeicon").setAttribute("xlink:href", "#icon-moon"))
}
...
function changeLight(e) {
    document.getElementById("site-name") && (document.getElementById("site-name").style.animation = e ? "light_15px 10s linear infinite" : "none"),
...
function createWinbox() {
    ...
    "1" == localStorage.getItem("bgFilterOn") ? document.getElementById("bgFilterSet").checked = !0 : "0" == localStorage.getItem("bgFilterOn") && (document.getElementById("bgFilterSet").checked = !1),
    document.getElementById("blurRad").value = blurRadius,
    document.getElementById("saturation").value = saturate,
    document.getElementById("contrast").value = contrast,
    "block" == localStorage.getItem("universe") ? document.getElementById("universeSet").checked = !0 : "none" == localStorage.getItem("universe") && (document.getElementById("universeSet").checked = !1),
    "1" == localStorage.getItem("fpson") ? document.getElementById("fpson").checked = !0 : document.getElementById("fpson").checked = !1,
    "block" == localStorage.getItem("rs") ? document.getElementById("rightSideSet").checked = !0 : "none" == localStorage.getItem("rs") && (document.getElementById("rightSideSet").checked = !1),
    "true" == localStorage.getItem("light") ? document.getElementById("lightSet").checked = !0 : document.getElementById("lightSet").checked = !1,
    setFontBorder(),
    "block" == localStorage.getItem("snow") ? document.getElementById("snowSet").checked = !0 : "none" == localStorage.getItem("snow") && (document.getElementById("snowSet").checked = !1),
    ...
    "1" == localStorage.getItem("aside") ? document.getElementById("asideSet").checked = !0 : "0" == localStorage.getItem("aside") && (document.getElementById("asideSet").checked = !1),
    "1" == localStorage.getItem("asidePos") ? document.getElementById("asidePosSet").checked = !0 : "0" == localStorage.getItem("asidePos") && (document.getElementById("asidePosSet").checked = !1)
}
function resetBg() {
...
function reset() {
    ...
    document.getElementById("bgFilterShow").innerHTML = '模糊半径: <span style="color:#eb5353">0px</span> | 饱和度: <span style="color:#eb5353">108%</span> | 对比度: <span style="color:#eb5353">105%</span>',
